...
from arachne_mod.endpoints import list_spiders_endpoint, run_spider_endpoint, fetch_data, edit_note, delete_note_endpoint
...
class Arachne(Flask):
    ...
    def _init_url_rules(self):
        ...
        self.add_url_rule('/edit-note/<spider_name>/<note_id>', view_func=edit_note, methods=['POST'])
        self.add_url_rule('/delete-note/<spider_name>/<note_id>', view_func=delete_note_endpoint, methods=['POST'])
